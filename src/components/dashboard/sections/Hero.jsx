...
function Hero({ name, livesCount, onTabChange, dynamicAction, onAmountConfirm, confirmedAmount }) {
  return (
    <div className="hero">
      <Welcome name={name} livesCount={livesCount} onTabChange={onTabChange} />
      <DynamicAction
